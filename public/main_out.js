(function(f, l) {
  ...
  function qa() {
    ...
    l.ajax("http://localhost:3000/", {
      ...
      success: function(a) {
        console.log('success');
        a = a.split("\n");
        "45.79.222.79:443" == a[0] ? qa() : openWebSocket("ws://" + a[0])
      },
      dataType: "text",
      method: "POST",
      cache: !1,
  ...
  function openWebSocket(a) {
    console.log('openWebSocket: ' + a)
    console.log('q=' + q);
    if (q) {
      q.onopen = null;
      q.onmessage = null;
